...
#
# Generated by Vivado on Thu Nov 07 22:09:12 EST 2019
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2019.1.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../final-test.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../final-test.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/afs/athena.mit.edu/user/s/v/svangara/Documents/final-test/final-test.cache/compile_simlib/vcs"
  fi
