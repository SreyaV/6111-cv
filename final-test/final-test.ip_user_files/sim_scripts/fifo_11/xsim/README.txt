...
#
# Generated by export_simulation on Wed Nov 20 23:17:27 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './fifo_11.sh' script.

./fifo_11.sh -reset_run
...
./fifo_11.sh -noclean_files

For more information on the script, please type './fifo_11.sh -help'.
