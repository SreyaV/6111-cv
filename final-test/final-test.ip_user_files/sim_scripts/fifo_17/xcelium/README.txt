...
#
# Generated by export_simulation on Wed Nov 20 01:08:58 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './fifo_17.sh' script.

./fifo_17.sh -reset_run
...
./fifo_17.sh -noclean_files

For more information on the script, please type './fifo_17.sh -help'.
