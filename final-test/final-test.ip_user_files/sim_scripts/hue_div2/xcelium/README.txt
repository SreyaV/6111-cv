...
#
# Generated by export_simulation on Sun Nov 17 12:56:45 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './hue_div2.sh' script.

./hue_div2.sh -reset_run
...
./hue_div2.sh -noclean_files

For more information on the script, please type './hue_div2.sh -help'.
