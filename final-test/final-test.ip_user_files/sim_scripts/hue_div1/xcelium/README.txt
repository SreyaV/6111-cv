...
#
# Generated by export_simulation on Sun Nov 17 12:55:53 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './hue_div1.sh' script.

./hue_div1.sh -reset_run
...
./hue_div1.sh -noclean_files

For more information on the script, please type './hue_div1.sh -help'.
