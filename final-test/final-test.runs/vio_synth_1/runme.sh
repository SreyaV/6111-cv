...
HD_PWD='C:/Users/Sreya Vangara/Documents/MIT/6.111/6.111/Final/final-test/final-test.runs/vio_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio.tcl
