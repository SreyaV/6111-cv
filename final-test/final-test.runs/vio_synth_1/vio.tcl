...
synth_design -top vio -part xc7a200tsbg484-3 -mode out_of_context
...
set TIME_taken [expr [clock seconds] - $TIME_start]
 ...
 config_ip_cache -add -dcp vio.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips vio]
}
