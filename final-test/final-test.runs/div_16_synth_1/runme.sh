...
HD_PWD='C:/Users/Jeremy/6111-cv/final-test/final-test.runs/div_16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_16.tcl
