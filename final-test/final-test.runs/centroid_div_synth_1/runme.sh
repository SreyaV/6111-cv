...
HD_PWD='C:/Users/Sreya Vangara/Documents/MIT/6.111/6.111/Final/final-test/final-test.runs/centroid_div_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log centroid_div.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source centroid_div.tcl
