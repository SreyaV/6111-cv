...
HD_PWD='C:/Users/Sreya Vangara/Documents/MIT/6.111/6.111/Final/final-test/final-test.runs/hue_div2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hue_div2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hue_div2.tcl
