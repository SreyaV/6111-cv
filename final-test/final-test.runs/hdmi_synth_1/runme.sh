...
HD_PWD='C:/Users/Jeremy/6111-cv/final-test/final-test.runs/hdmi_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi.tcl
